...
| **is_high_variance** | Validated — fade classification | 14 starts | Yesavage std 8.20/mean 15.63 correctly triggers high variance |
| **walks_suppression** | Validated — control gate | 188 instances | Suppresses 42.0% of walk penalties, shielding control starters |
| **slate_compression** | Validated — small sample | 6 instances | Compressed slates have +50% top hitter DK points (13.50 vs 9.00) |
| **stack_cannibalization** | Validated — GPP sizing | 220 instances | 2-man joint rate 26.5% (1.06x), 3-man 2.2% (0.65x due to cannibalization) |
