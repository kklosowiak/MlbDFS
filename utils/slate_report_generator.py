                ...
                if side_hitters:
                    ...
                    for h in side_hitters:
                        ...
                        lines.append(
                            ...
                            f"| {h['ahr_price']:+d} | {h.get('hit_line', '-')}@{h.get('hits_price', 0)} "
                            f"| {flag_str} |"
                        )
                    lines.append("")
