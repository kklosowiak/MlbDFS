        ...
        <div class="handbook-content-area">
            ...
            <div id="sec-stacks" style="margin-bottom: 60px; padding-top: 40px; border-top: 1px solid var(--border);">
                ...
                <ul style="font-size: 1.0rem; line-height: 1.8; color: rgba(255,255,255,0.85); padding-left: 20px;">
                    ...
                    <li><strong style="color:var(--accent-blue);">ML MOVE & TT MOVE (Moneyline & Team Total Movement):</strong> Shows how betting lines have shifted since opening. For Team Totals (TT), a positive move (e.g., `+0.5`) is positive steam. For Moneyline (ML) in American odds, a negative shift (e.g., `-15`) indicates the price became more expensive/favored, meaning heavy money is flooding in to back them (styled green as 'val-up' in your cockpit).</li>
